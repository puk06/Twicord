...
const MESSAGES = {
    ja: {
        ...
        warn_permission_abuse: "注意: 通常は書き込めないチャンネルに投稿しています。権限を乱用している可能性があります。チャンネルオーナー: {owner}",
    ...
    en: {
        ...
        warn_permission_abuse: "Warning: You are posting in a channel that is normally not writable. You may be abusing permissions. Channel owner: {owner}",
